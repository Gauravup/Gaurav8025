# Generated by Django 5.0.1 on 2024-03-05 20:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TITAN', 'Titan'), ('NOICE', 'Noice'), ('TIMEX', 'Timex'), ('NAVYFORCE', 'Navyforce')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(default=1)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Myapp.watch')),
            ],
        ),
    ]
